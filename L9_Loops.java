...
public class L9_Loops {
    public static void main(String[] args){
        // while loop example
        int i = 0; // declare a variable i with 0 value
        while (i < 5) { // declare the while with the condition of i < 5
            System.out.println(i); // if the condition is true, the system will print i value on the console
        ...
        do{
            System.out.println(x); // the code will be execute first before checking the condition
        ...
        for (z = 0; z < 5; z++){ // the loop will occurs if the z value is smaller than 5
        ...
        for (int index = 0; index < 10; index++) { // this for loop will keep print out index value once the index value is smaller than 10
            if (index == 4) { // if the index reaches the number of 4
                break; // the loop will be break here
            }
            System.out.println(index); // Output : 0 1 2 3
        }
        ...
        for (int count = 0; count < 10; count++) {
            if (count == 4) { // the loop break when reach number of 4
                continue; // but then continue the loop
            }
            System.out.println(count); // Output : 0 1 2 3 5 6 7 8 9
        }
